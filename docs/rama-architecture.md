...
> Landlord: *"Did Sarah pay rent this month?"*
...
> Landlord: *"Charge her a $25 late fee."*
...
which renders as a confirm card in the dashboard. On approval, the *existing*
...
— is *versioned config, not knowledge*:
...
- Only the *active* version's text enters the model's context. History is
...
the dashboard for humans *before* any AI exists — which is the test every
