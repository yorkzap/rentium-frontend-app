      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <p className="mt-1 text-sm text-[hsl(var(--ink-4))]">
            A complete unit — apartment, suite, house — or a single room in a
            shared home.
          </p>
        </button>
        ...
        >
          ...
          <p className="mt-1 text-sm text-[hsl(var(--ink-4))]">
            The shared parts of one home: the kitchen, bathroom and living room
            that several rooms have in common. Make this first if you&apos;re
            renting out rooms.
          </p>
        </button>
      </div>
