      ...
      <div className="mx-auto max-w-6xl px-4 py-20 text-center sm:px-6 lg:py-24">
        <Reveal>
          <h2 className="text-title mx-auto max-w-2xl text-ink">
            The next tenancy you start could be the first one with nothing to
            chase.
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-base leading-7 text-ink-3">
            Set up your first property in minutes. Thirty days free, every
            feature included.
          </p>
