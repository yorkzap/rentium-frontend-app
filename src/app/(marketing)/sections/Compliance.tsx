          ...
          <Reveal>
            <div>
              ...
              <h2 className="text-title mt-3">
                Compliance isn&rsquo;t a feature here. It&rsquo;s the
                foundation.
              </h2>
              <p className="mt-4 text-base leading-7 text-ink-inverse-muted">
                Every province rents under its own rules, so Rentium encodes
                tenancy law province by province — the rules engine decides what
                each tenancy requires, and the app tells you what&rsquo;s due
                and when. British Columbia&rsquo;s RTB rulebook is live today;
                the rest of Canada is what the engine was built for.
              </p>
