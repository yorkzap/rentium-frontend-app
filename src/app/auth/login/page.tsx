  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-ink-3">
        New to Rentium?{' '}
        <Link href="/auth/signup" className="font-medium text-brand hover:text-brand-hover">
          Create an account
        </Link>
      </p>
      ...
      {verificationNeeded && (
        <div className="mt-6 rounded-lg border border-warn/40 bg-warn-soft p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-sm font-medium text-warn-ink">Email verification required</h2>
