...
export async function confirmAppointment(
  token: string, id: string, startsAt?: string,
): Promise<Appointment> {
...
export async function declineAppointment(token: string, id: string, reason = ""): Promise<Appointment> {
...
export async function fetchPublicProperty(propertyId: string | number): Promise<PublicProperty> {
