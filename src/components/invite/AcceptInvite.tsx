...
export default function AcceptInvite({
  ...
  const { login } = useAuth() as {
    login?: (authToken: string, user: unknown) => void;
  };
    ...
    const loadPreview = async () => {
      ...
      try {
        ...
        if (!res.ok) {
          ...
          throw new Error(
            body.detail || 'This invite link is invalid or has expired.'
          );
        }
        ...
        <Card className="max-w-md w-full">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-destructive font-medium">
              {previewError || 'Invite not found.'}
            </p>
            <p className="text-sm text-slate-500 mt-2">
              Ask your landlord to resend the invite if you think this is a
              mistake.
            </p>
          </CardContent>
        </Card>
      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
        <Card className="max-w-md w-full">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              This lease has already been signed. If you don&apos;t have an
              account yet, ask your landlord for a fresh invite link, or try
              logging in if you&apos;ve already set a password.
            </CardDescription>
          </CardHeader>
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
      <Card className="max-w-md w-full">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Set a password to create your account, then you&apos;ll be able to
            review and sign.
          </CardDescription>
        </CardHeader>
