      ...
      <div className="container mx-auto px-6">
        <div className="text-center section-heading">
          ...
          <p className="mt-5 section-des">
            Free forever. Upgrade for unlimited features, better security, and exclusive perks.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6 items-center mt-10 lg:flex-row lg:items-end lg:justify-center">
          {pricingTiers.map(({ title, monthlyPrice, buttonText, popular, features, inverse }) => (
            ...
            >
                ...
                {popular && (
                  <div className="inline-flex text-sm px-4 py-1.5 rounded-xl border border-white/20">
                    <motion.span
                      ...
                      className="bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF)] bg-clip-text text-transparent font-medium"
                    >
                      Popular
                    </motion.span>
                  </div>
              ...
              <button className={twMerge("btn btn-primary w-full mt-8", inverse && "bg-white text-black")}>
                {buttonText}
              </button>
